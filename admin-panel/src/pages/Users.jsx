...
const Users = ({ users, onAdd, onEdit, onDelete }) => {
    return (
        <div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                        <tr style={{ backgroundColor: 'rgba(138, 43, 226, 0.1)', borderBottom: '1px solid rgba(138, 43, 226, 0.3)' }}>
                            ...
                            <th style={{ padding: '16px', textAlign: 'left', color: 'var(--text-primary)', fontWeight: '600' }}>Role</th>
                            <th style={{ padding: '16px', textAlign: 'left', color: 'var(--text-primary)', fontWeight: '600' }}>Joined Date</th>
                        ...
                        {users.map(user => (
                            ...
                            >
                                ...
                                <td style={{ padding: '16px' }}>
                                    <span style={{
                                        backgroundColor: user.role === 'Admin' ? 'rgba(138, 43, 226, 0.2)' : 'rgba(59, 130, 246, 0.2)',
                                        color: user.role === 'Admin' ? 'var(--primary-color)' : '#3b82f6',
                                        padding: '6px 12px',
                                        borderRadius: '8px',
                                        fontSize: '0.85rem',
                                        fontWeight: '600'
                                ...
                                <td style={{ padding: '16px', color: 'var(--text-secondary)' }}>{user.joinedDate}</td>
                                <td style={{ padding: '16px' }}>
